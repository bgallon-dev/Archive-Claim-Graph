...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="gemynd", description="Claim-centric narrative report graph pipeline.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "verify-integrity":
        ...
        from gemynd.core.graph.cypher import INTEGRITY_CHECK_QUERY
    ...
    if args.command == "export-corpus":
        from gemynd.ingest.export import export_semantic_csv, render_html_report, render_ead_xml
