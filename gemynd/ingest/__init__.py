...
class IngestPipeline:
    ...
    def parse_source(path, **kwargs):
        ...
        Delegates to :func:`gemynd.ingest.pipeline.parse_source`.
        """
    ...
    def extract_semantic(structure, **kwargs):
        ...
        Delegates to :func:`gemynd.ingest.pipeline.extract_semantic`.
        """
    ...
    def extract_document(input_item, **kwargs):
        ...
        Delegates to :func:`gemynd.ingest.pipeline.extract_document`.
        """
    ...
    def persist_document(result, out_dir, **kwargs):
        ...
        Delegates to :func:`gemynd.ingest.pipeline.persist_document`.
        """
    ...
    def quality_report(structure, semantic, **kwargs):
        ...
        Delegates to :func:`gemynd.ingest.pipeline.quality_report`.
        """
    ...
    def build_spelling_review_queue(structure, semantic, **kwargs):
        ...
        Delegates to
        :func:`gemynd.ingest.pipeline.build_spelling_review_queue`.
        """
    ...
    def run_e2e(*args, **kwargs):
        ...
        Delegates to :func:`gemynd.ingest.pipeline.run_e2e`.
        """
    ...
    def resolve_mentions_targeted(*args, **kwargs):
        ...
        Delegates to
        :func:`gemynd.ingest.pipeline.resolve_mentions_targeted`.
        """
