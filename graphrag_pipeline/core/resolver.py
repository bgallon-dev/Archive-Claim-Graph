...
from graphrag_pipeline.shared.resource_loader import load_claim_relation_compatibility, load_seed_entity_rows

if TYPE_CHECKING:
    from graphrag_pipeline.ingest.extractors.mention_extractor import ResolutionContext
