...
def _get_spec(
    ...
    Accepts both :class:`~graphrag_pipeline.core.domain_config.ClaimDerivationSpec`
    objects (from :func:`~graphrag_pipeline.core.domain_config.load_domain_config`) and
    raw dicts (from :func:`~graphrag_pipeline.shared.resource_loader.load_derivation_registry`).
