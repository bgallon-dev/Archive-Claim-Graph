...
This module is now a thin shim over ``graphrag_pipeline.auth``.
...
from graphrag_pipeline.auth.models import ROLE_PERMITTED_LEVELS, UserContext  # noqa: F401

# require_user is an alias for require_login.  Both names work as FastAPI
# Depends() targets.
from graphrag_pipeline.auth.dependencies import require_login as require_user  # noqa: F401
